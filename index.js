function App(){
    ...
    return(
        <div className="center-align">
            ...
            <h3 id="break-length">{onBreak ? "Break" : "Session"}</h3>
        ...
        <div>
            ...
            <div className="time-sets">
                <button id="break-decrement" className="btn-small deep-purple lighten-2"
                    ...
                    <i id="session-decrement" className="material-icons">arrow_downward</i>
                </button>

                <h3 id="session-label">{formatTime(time)}</h3>
                <button id="break-increment"className="btn-small deep-purple lighten-2"
                        onClick={() => changeTime(60, type)}>
                    <i id="session-increment" className="material-icons">arrow_upward</i>
                </button>
            </div>
